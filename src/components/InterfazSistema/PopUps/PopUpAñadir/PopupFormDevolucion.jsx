...
const PopupFormDevolucion = ({ onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://localhost:8081/home/devolucion", formData)
      .then((res) => 
      {
        console.log(res)
          location.reload(TablaDevolucion);
      })
      ...
      <div className="relative w-full max-w-md p-6 my-8 mx-auto bg-white rounded-md shadow-lg">
        <form onSubmit={handleSubmit}>
          ...
          <select
            id="tipoCantidad"
            name="tipoCantidad"
            onChange={(e) => setFormData({ ...formData, tipoCantidad: e.target.value})}
            className="mt-1 w-full p-2 border border-gray-300 rounded-md"
          >
...
export default PopupFormDevolucion; 